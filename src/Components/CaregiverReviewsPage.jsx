  ...
  featured: [
    {
      ...
      nulla vitae laoreet augue. Amet feugiat est integer dolor
...
export default function CaregiverReviewsPage() {
  ...
  return (
    <div className="bg-white h-auto">
        <h1 className="text-center pt-10 text-4xl text-gray-700">Naomi Ratings</h1>
      <div className="mx-auto max-w-2xl  px-4 sm:py-24 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-12 lg:gap-x-8 lg:px-8">
